<table border="1">
    <tx>
        <td colspan="2" style="text-align: center;"> <img src="{{ asset('PAGINAIMAGEN/alumnos.jpg') }}" alt='ADMI' width="200" height="150">
        </td>
    </tx>
    <tx> 
        <td>
        ...
        <td>
            Esta es la lista de los alumnos
        </td>
    </tx>
</table>
...
<html>
   ...
   <body>
        <h1 class= "titulo">COMUNIDAD ESTUDIANTIL </h1>
